...
func ApplyTerraformProvider() *defkit.WorkflowStepDefinition {
	...
	return defkit.NewWorkflowStep("apply-terraform-provider").
		...
		Helper("AzureProvider", defkit.Struct("AzureProvider").WithFields(
			defkit.Field("subscriptionID", defkit.ParamTypeString),
			defkit.Field("tenantID", defkit.ParamTypeString),
			defkit.Field("clientID", defkit.ParamTypeString),
			defkit.Field("clientSecret", defkit.ParamTypeString),
		...
		Helper("ECProvider", defkit.Struct("ECProvider").WithFields(
			defkit.Field("type", defkit.ParamTypeString).Values("ec"),
		...
		Helper("GCPProvider", defkit.Struct("GCPProvider").WithFields(
			defkit.Field("credentials", defkit.ParamTypeString),
			defkit.Field("region", defkit.ParamTypeString),
			defkit.Field("project", defkit.ParamTypeString),
			defkit.Field("type", defkit.ParamTypeString).Values("gcp"),
		...
		Helper("TencentProvider", defkit.Struct("TencentProvider").WithFields(
			defkit.Field("secretID", defkit.ParamTypeString),
			defkit.Field("secretKey", defkit.ParamTypeString),
			defkit.Field("region", defkit.ParamTypeString),
			defkit.Field("type", defkit.ParamTypeString).Values("tencent"),
		...
		Helper("UCloudProvider", defkit.Struct("UCloudProvider").WithFields(
			defkit.Field("publicKey", defkit.ParamTypeString),
			defkit.Field("privateKey", defkit.ParamTypeString),
			defkit.Field("projectID", defkit.ParamTypeString),
			defkit.Field("region", defkit.ParamTypeString),
			defkit.Field("type", defkit.ParamTypeString).Values("ucloud"),
