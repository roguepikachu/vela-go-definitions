...
require (
	github.com/oam-dev/kubevela v1.10.5-0.20260310195120-79d1ee702907
...
replace github.com/oam-dev/kubevela => github.com/guidewire-oss/kubevela v0.0.0-20260312142903-c30c9bdf1d2f
